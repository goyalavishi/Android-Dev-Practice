...
//                startActivity(intent);
    ...
    public void onSignupSuccess() {
        ...
        db.insert(new DataBaseOperations(this),name,password,email,mobile);
        new Thread(){
            @Override
            public void run() {
    ...
    public void onSignupFailed() {
        Toast.makeText(getBaseContext(), "Sign Up failed", LENGTH_LONG).show();
    ...
    public boolean validate() {
        ...
        if(flag) {
            emailText.setError("Already registered.");
            valid = false;
        }
        else {
